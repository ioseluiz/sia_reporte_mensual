...
class ProjectsWithoutMembersDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("Proyectos sin Integrantes")
    ...
    def _setup_ui(self):
        ...
        header = QHBoxLayout()
        title = QLabel("Proyectos sin integrantes registrados")
        bold = QFont()
        bold.setBold(True)
        title.setFont(bold)
        ...
        self.lbl_summary = QLabel("Cargando proyectos sin integrantes…")
    ...
    def display_results(self, data: list[dict]):
        ...
        if not data:
            ...
            self.table.setSortingEnabled(True)
            self.lbl_summary.setText("No se encontraron proyectos sin integrantes para el filtro seleccionado.")
        ...
        self.lbl_summary.setText(f"{len(data)} proyecto(s) sin integrantes ({modo}).")
        self.lbl_filtered.setText("")
